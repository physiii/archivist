...
- Collections: Milvus-backed catalog and search
...
- Do not pretend the workspace is a container path when a host path exists.
- Do not hide runtime failures behind generic success language.
- Do not discard evidence links or session context when summarizing.
